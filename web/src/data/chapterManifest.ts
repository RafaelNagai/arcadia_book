...
export const CHAPTERS: ChapterMeta[] = [
  ...
  { id: '05_invocacao',               slug: 'invocacao',               title: 'Invocação',                part: 'O Arcano',               order: 62,  subtitle: 'Trazendo entidades ao Plano Finito', parentSlug: 'arcanismo' },
  { id: '06_elementos_e_afinidades',  slug: 'elementos-e-afinidades',  title: 'Elementos e Afinidades',   part: 'O Arcano',               order: 70,  subtitle: 'Cinco forças, um destino' },
  ...
  { id: '14_dimensoes',               slug: 'dimensoes',               title: 'Dimensões',                part: 'O Mundo',                order: 150, subtitle: 'Além do Plano Finito' },
