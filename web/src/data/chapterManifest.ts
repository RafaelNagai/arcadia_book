...
export const CHAPTERS: ChapterMeta[] = [
  ...
  { id: '05_01_energia',              slug: 'energia',                 title: 'Energia',                  part: 'O Arcano',               order: 82,  subtitle: 'Onde a pura intenção precede a própria criação', parentSlug: 'elementos' },
  { id: '05_02_anomolia',             slug: 'anomolia',                title: 'Anomalia',                 part: 'O Arcano',               order: 83,  subtitle: 'Onde a matéria obedece e a física se curva', parentSlug: 'elementos' },
  { id: '05_03_paradoxo',             slug: 'paradoxo',                title: 'Paradoxo',                 part: 'O Arcano',               order: 84,  subtitle: 'Onde a verdade perde o consenso e o absoluto se torna relativo', parentSlug: 'elementos' },
  { id: '05_04_cognitivo',            slug: 'cognitivo',               title: 'Cognitivo',                part: 'O Arcano',               order: 85,  subtitle: 'Onde a mente se torna o verdadeiro campo de batalha', parentSlug: 'elementos' },
  { id: '05_05_astral',               slug: 'astral',                  title: 'Astral',                   part: 'O Arcano',               order: 86,  subtitle: 'Onde as fronteiras do mundo físico se rompem', parentSlug: 'elementos' },
