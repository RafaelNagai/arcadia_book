...
> = {
  Energia: {
    text: "#E8803A",
    bg: "rgba(200,90,32,0.18)",
    glow: "rgba(232,128,58,0.45)",
  },
  Anomalia: {
    text: "#6FC892",
    bg: "rgba(42,155,111,0.18)",
    glow: "rgba(111,200,146,0.45)",
  },
  Paradoxo: {
    text: "#50C8E8",
    bg: "rgba(32,143,168,0.18)",
    glow: "rgba(80,200,232,0.45)",
  },
  Astral: {
    text: "#C090F0",
    bg: "rgba(107,63,160,0.18)",
    glow: "rgba(192,144,240,0.45)",
  },
  Cognitivo: {
    text: "#E8B84B",
    bg: "rgba(200,146,42,0.18)",
  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      <span
        ...
        style={{ color: "#B060D0", fontFamily: "var(--font-ui)" }}
      >
  ...
  return (
    <div style={{ background: "var(--color-abyss)", minHeight: "100vh" }}>
      ...
      >
        ...
        <motion.div
          style={{
            opacity: useTransform(scrollY, [0, 180], [0.65, 0]),
            position: "absolute",
            bottom: 24,
            right: 24,
          }}
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-12">
        ...
        <section>
          <SectionLabel
            accent={accent.text}
            edits={
              owned ? [{ label: "identidade", fn: () => goEdit(1) }] : undefined
            }
          >
            Vitalidade
          </SectionLabel>
        ...
        <section>
          ...
          >
            ◆ com talento — permite rolar 3D12 em testes de perícia · ◇ sem
            talento
          </p>
        </section>
        ...
        <section>
          ...
          <div
            className="rounded-sm p-5 space-y-5"
            style={{
              background: "rgba(4,10,20,0.7)",
          ...
          >
            <div className="flex flex-wrap gap-6">
              <div>
                ...
                <Tag color={accent.text} bg={accent.bg}>
                  {character.afinidade}
                </Tag>
              </div>
              <div>
                ...
                <Tag color={antAccent.text} bg={antAccent.bg}>
                  {character.antitese}
                </Tag>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {character.runas.map((runa) => (
                    <Tag key={runa} color="#B060D0" bg="rgba(128,40,160,0.15)">
                      {runa}
                    </Tag>
                  ))}
                </div>
