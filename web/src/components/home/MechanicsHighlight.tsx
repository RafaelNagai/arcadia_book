...
const PILLARS = [
  ...
  },
  {
    ...
    body: "O navio é um personagem a parte. A Moral da Tripulação é um recurso tão valioso quanto munição. Um grito de guerra pode virar uma batalha; a perda de um companheiro pode destruir a equipe.",
    slug: "moral",
  },
  {
    number: "03",
    title: "Magia Criativa e Perigosa",
    body: "O Arcanismo não tem lista de feitiços. Você define a sua Intenção para conjurar suas magias — mas cada uso cobra um preço em Sanidade. Poder demais te torna algo que não é mais humano.",
    slug: "arcanismo",
  },
  {
    number: "04",
    title: "Combate Dinâmico",
    body: "Cada individuo cria um ritmo e desenvolve a cena junto com o mestre, tendo seu momento como Protagonista — e qualquer um pode Intervir ou se Impor para mudar o rumo do combate.",
    slug: "combate",
  },
];
...
const MECHANICS = [
  ...
  },
  {
    ...
    body: "5D12 formam o Pote da Moral. O Grito de Guerra converte dados ruins em sucessos. Quando o pote esvazia, a tripulação entra em colapso — e nenhuma magia do mundo vai salvar um navio sem moral.",
    slug: "moral",
  ...
  },
  {
    ...
    body: "Cinco elementos, intenções livres que formam a magia. Cada uso drena Sanidade. Três traumas e você mergulha na Loucura — um minijogo de sobrevivência mental onde as regras mudam.",
    slug: "arcanismo",
    accent: "#9B6FD0",
  },
];
