...
export function loadPreferredTokenSize(
  characterId: string,
  mapDefault: number,
): number {
...
export function MapTokenModal({
  ...
  const sharingChanged =
    JSON.stringify([...localShared].sort()) !==
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          <a
            href={`/ficha/${character.id}?campaignId=${campaignId}`}
            target="_blank"
          ...
          {!useMapDefault && (
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setRadius(
                    Math.min(2000, Math.max(50, Number(e.target.value))),
                  )
                }
                style={{
                  width: 60,
