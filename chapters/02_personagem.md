...
Personagens com alto Físico são difíceis de derrubar. Continuam de pé após golpes que deixariam outros inconscientes, carregam mais, resistem mais, e quando batem, o mundo sente.

> *Não é sobre ser grande. É sobre ser inabalável.*
...
É também o pilar interno de rituais e magias de concentração — a âncora que mantém a mente firme enquanto o Arcano flui.

**Exemplos de uso:**
- Resistir a efeitos de medo, dominação ou ilusão.
- Manter o foco em uma magia de longa duração.
- Enfrentar situações psicológicas intensas sem ceder.
- Recuperar-se rapidamente após um trauma.
...
**Exemplos de uso:**
- Escalar uma muralha ou atravessar um rio a nado.
- Saltar entre telhados ou sobre um abismo.
- Executar uma corrida de resistência.
- Derrubar uma porta com o corpo.
...
Cada estilo de luta (espada, lança, garras, punhos) pode ser interpretado dentro dessa mesma perícia. O número é o mesmo; a narrativa é sua.
...
Onde o Físico quebra, a Destreza contorna.

> *Um guerreiro forte pode derrubar uma parede. Um guerreiro ágil nunca precisou chegar perto dela.*
...
**Exemplos de uso:**
- Saltar sobre obstáculos durante uma perseguição.
- Aterrissar com segurança após uma queda.
- Passar por espaços estreitos ou campos de armadilhas.
- Manter o equilíbrio sobre superfícies instáveis — como o convés de um navio em tormenta.
...
**Exemplos de uso:**
- Evitar o golpe de uma espada ou projétil.
- Saltar para fora de uma explosão ou área de efeito.
- Pegar algo que caiu antes que toque o chão.
- Reagir a uma emboscada antes dos outros.
...
**Exemplos de uso:**
- Perceber alguém se aproximando sorrateiramente.
- Notar uma alteração no ambiente ou num objeto.
- Identificar uma armadilha ou feitiço oculto.
- Detectar uma presença invisível.
...
**Exemplos de uso:**
- Sentir que alguém está mentindo, mesmo sem provas.
- Pressentir um perigo iminente antes que ele se manifeste.
- Compreender emoções e motivações alheias sem que sejam verbalizadas.
- Perceber influências sobrenaturais sutis.

> **Importante:** Um resultado alto em Intuição não garante uma resposta correta — garante a melhor leitura possível *com as informações disponíveis no momento*. Se o personagem foi deliberadamente enganado com informações falsas, sua intuição será igualmente enganada.

> **Para o Mestre — Intuição vs. Percepção:** A fronteira entre as duas perícias é o *tipo* de informação. Use **Percepção** quando o personagem está detectando o mundo físico: um som, um cheiro, um movimento, uma armadilha. Use **Intuição** quando o personagem está lendo o mundo emocional e intencional: uma mentira, uma motivação escondida, um perigo que ainda não tem forma. Em caso de dúvida, pergunte-se: *"O personagem está usando os sentidos ou o instinto?"*
...
**Exemplos de uso:**
- Montar a sequência de um crime ou evento.
- Descobrir o funcionamento de um mecanismo ou artefato.
- Procurar e encontrar itens escondidos em um espaço.
- Identificar contradições em um relato.
...
É uma perícia fundamentalmente pessoal: seu alcance depende do *passado* do personagem. Na criação, o jogador define as **áreas de Conhecimento** que seu personagem domina — chamadas de **antecedentes**. Não há limite de quantidade: o jogador pode definir quantos antecedentes fizerem sentido para a história do personagem.

Os antecedentes representam a vida anterior do personagem — profissões, vínculos, origens. Exemplos: *Pirata, Marinheiro, Mafioso, Imperial, Mestre de Guilda, Contrabandista, Curandeiro de Campo, Monge Arcano, Mercenário, Nobre Caído, Ferreiro, Cartógrafo.* Qualquer profissão ou origem é válida, desde que o jogador consiga justificar como ela moldou o que o personagem sabe.

Durante o jogo, o Mestre solicita testes de Conhecimento quando uma memória ou referência do passado pode ajudar o personagem a compreender uma situação presente.

**Exemplos de uso:**
- Lembrar-se de um símbolo, runa ou criatura vista anteriormente.
- Identificar o propósito de um artefato ou construção antiga.
- Recordar táticas de batalha ou estruturas políticas de um reino.
- Usar memórias pessoais para reconhecer alguém ou algo importante.

> O Conhecimento é a ponte entre o passado e o presente — representa tudo o que o personagem sabe, e como esse saber pode mudar o rumo da história.
