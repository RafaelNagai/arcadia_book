...
> *Uma fechadura não é apenas uma barreira. É um problema esperando a pergunta certa.*

## Visão geral

A mecânica de **Destrancar** transforma a abertura de uma fechadura em um pequeno desafio de dedução. Ela pode ser usada para portas, baús, cofres e outras trancas quando abrir o objeto for uma parte importante da cena.

O Mestre prepara a tranca com uma sequência de valores ocultos. Cada valor representa a posição correta de um pino.
...
- **Maior:** o valor correto é maior que o palpite.
...
Antes do início das tentativas, o personagem deve realizar um teste de **Percepção**. Ele também pode realizar um teste de **Precisão** se possuir um antecedente, treinamento ou experiência que justifique sua capacidade de manipular fechaduras. Esses testes representam a leitura da fechadura e o controle da ferramenta.

### Percepção

A cada **10 pontos obtidos no teste de Percepção**, o personagem recebe **1 dica** sobre os valores ocultos da tranca. Pontuações entre 0 e 9 não concedem dicas; 10 a 19 concedem 1 dica; 20 a 29 concedem 2 dicas, e assim por diante. As dicas devem fornecer uma informação verdadeira e útil sobre um ou mais pinos, sem revelar diretamente um valor inteiro.

Exemplos de dicas:

- O primeiro pino mostra um número par.
- O segundo e o terceiro pinos possuem o mesmo valor.
- Os três primeiros pinos estão em ordem crescente.
- O último pino possui um valor maior que o primeiro.

### Precisão

A cada **10 pontos obtidos no teste de Precisão**, o personagem revela **1 pino**, descobrindo o valor exato que precisa ser alinhado. Pontuações entre 0 e 9 não revelam pinos; 10 a 19 revelam 1 pino; 20 a 29 revelam 2 pinos, e assim por diante. A revelação acontece antes do início das tentativas.

O personagem só pode realizar o teste de Precisão se possuir um antecedente, treinamento ou experiência que justifique sua capacidade de manipular fechaduras, como ter sido ladrão, arrombador ou membro de uma profissão semelhante.
...
A tranca possui três pinos ocultos: **[6] [4] [1]**.
