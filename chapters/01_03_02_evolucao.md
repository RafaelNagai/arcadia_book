...
> *Ninguém aprende a voar lendo sobre pássaros. A perícia nasce do risco — e o domínio, do momento em que tudo se alinha.*
...
> Sempre que os seus dois **Dados Usados** resultarem em **12**, você ganha **+1 ponto permanente** naquela perícia.

Essa é a única forma de evolução orgânica de perícias. O +1 se soma diretamente ao bônus daquela perícia em todos os testes futuros. A mudança é imediata e irreversível.

---

## Condições

### O que conta como Evolução

- Os dois **Dados Usados** devem mostrar **12** — seja por resultado natural, seja elevados com [PE](esforco).
- A evolução ocorre **independentemente** de passar ou não na DT — o feito importa, não o resultado narrativo imediato.
...
Cada ponto permanente em uma perícia é uma mudança real nas capacidades do personagem. Não é um número em uma planilha — é evidência de que aquela habilidade foi exercida no limite e respondeu.

Com o tempo, um personagem que evoluiu Furtividade de 2 para 5 não apenas soma mais aos dados. Ele *é* outro tipo de operador. O sistema reflete isso diretamente: cada +1 é um passo que só o próprio personagem poderia dar, no momento em que importava.

---

## Interação com PE

Os [Pontos de Esforço](esforco) permitem forçar o valor de um Dado Usado para 12 — o que pode ser usado deliberadamente para acionar a evolução quando um dado "quase chegou lá".

Isso cria uma camada de decisão estratégica: o jogador que tem PE disponíveis pode escolher investir na evolução permanente em vez de usar os pontos para passar em uma DT imediata. É uma aposta de longo prazo — gastar agora para ganhar para sempre.

> Veja detalhes completos sobre como gastar e recuperar PE em [Pontos de Esforço](esforco).
