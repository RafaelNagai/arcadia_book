...
A **Moral** representa a coesão, a confiança e o estado emocional de todos a bordo. É um **recurso compartilhado** — não pertence a nenhum personagem individualmente, mas à tripulação como um todo.
...
No início de cada sessão (ou capítulo narrativo), o **Capitão** rola **5D12**. Esses dados formam o **Pote de Moral (PM)**.
...
A Moral só pode ser acessada em **Testes de Risco** — combates, manobras evasivas, situações de perigo de vida, ou qualquer momento em que as apostas sejam altas e o resultado importe. Testes mundanos ou sem pressão narrativa não permitem o uso deste recurso.
...
> O jogador sempre trocará um dado pior pelo melhor disponível no Pote — mas cada uso drena o recurso compartilhado.
...
>
> **Novo Pote de Moral:** [1, 3, 6, 8, 4] — Soma: 22. A tripulação sente o peso do esforço heróico do companheiro.
...
Há duas formas de devolver o ânimo ao Pote durante ou entre as sessões.

### A. Exemplo de Liderança — Troca Inversa

Um tripulante pode abdicar de um sucesso individual em prol do grupo. Ao rolar um dado alto em um teste, ele pode optar por **trocar esse dado por um dado de valor baixo** que esteja atualmente no Pote de Moral — o dado alto vai para o Pote, o dado baixo vai para o teste.
