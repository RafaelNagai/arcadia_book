...
>*"Onde a verdade perde o consenso, o absoluto se torna relativo e as leis do mundo passam a ser meras opiniões."*
...
| :--- | :--- | :--- |
| **Distorcer Trajeto** | Direção | Altera a direção de um projétil ou ataque inimigo em movimento, desviando-o para um alvo à escolha do conjurador. |
| **Colapso Gravitacional** | Gravidade | Intensifica drasticamente a gravidade sob o alvo, esmagando-o contra o solo e prendendo-o pelo peso. |
| **Dilatação Temporal** | Tempo | Altera o tempo para o alvo, desacelerando suas ações e reações em relação ao resto do mundo. |
| **Inverter Impacto** | Dano | Quando o conjurador recebe um ataque físico, a força do impacto é refletida de volta ao atacante. |
| **Aceleração Cinética** | Velocidade | Dobra a velocidade de um objeto lançado ou arma empunhada, multiplicando o dano do impacto físico. |
| **Fratura de Espaço** | Distância | Dobra a distância entre dois pontos, criando uma fenda espacial que causa dano ao alvo posicionado na intersecção. |
...
| **Elasticidade Temporal** | Tempo | Altera a duração, estendendo o tempo de funcionamento de um mecanismo ou efeito mundano ativo no ambiente. |
| **Desvencilhar Objeto** | Sólido | Desfaz temporariamente o conceito de solidez de um item trancado ou preso, permitindo separá-lo sem quebrar a estrutura. |

### Suporte
*Efeitos focados no conceito de antecipação temporal, salvaguardas de probabilidade e manipulação da física para beneficiar aliados.*
