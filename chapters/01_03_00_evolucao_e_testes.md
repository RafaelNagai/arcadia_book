...
> *O Mar de Nuvens não perdoa quem fica parado. Cada teste é uma aposta — e cada aposta ensina algo, mesmo quando você perde.*
...
Isso concede controle sobre o resultado: o jogador pode descartar o pior dado, maximizando a chance de sucesso — ou, em casos especiais, descartar um dado problemático para evitar ativar um efeito indesejado.

**Exemplo — descartando o pior:**
...
O resultado bruto dos dados — antes de somar qualquer bônus — pode gerar efeitos especiais que vão além de simplesmente passar ou falhar numa DT.
...
> **Exemplo — Conjuração:** Theron rola [1, 1] tentando controlar uma invocação. O feitiço não apenas falha — ele se volta contra o próprio conjurador, e a criatura invocada fica completamente fora de controle.
...
|---|---|---|
| 12 em um dado usado | **Crítico** | Sucesso amplificado |
| 12 nos dois dados usados | **Milagre** | Feito lendário + Evolução |
| 1 em um dado usado + falha na DT | **Falha Crítica** | Complicação inesperada |
| 1 nos dois dados usados | **Desastre** | Catástrofe narrativa imediata |

---

## Vantagem e Desvantagem

Certas situações tornam uma ação mais fácil ou mais difícil — não pela DT, mas pela quantidade de dados disponíveis.

### Desvantagem

O personagem opera em condições adversas. Cada nível de Desvantagem **remove um dado** da rolagem:

| Dados normais | Com 1 Desvantagem | Com 2 Desvantagens |
|---|---|---|
...
- Equipamento especializado e de alta qualidade para aquela ação
- Operar em ambiente ideal para a perícia
- Benefício de uma magia ou bênção ativa
- Preparação prévia e conhecimento específico do alvo

> A Vantagem não garante sucesso — ela aumenta as opções. Com mais dados na mesa, o jogador tem maior controle sobre o resultado final, mas a DT continua sendo o que define o êxito.
